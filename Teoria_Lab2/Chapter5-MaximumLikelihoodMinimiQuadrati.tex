...
\begin{figure}[ht]
\vspace{0.2in}
\includegraphics[scale = 0.3]{likeGauss}	
\centering
\vspace{0.2in}
...
\begin{wrapfigure}{l}{0.\textwidth}
\centering
\includegraphics[scale = 0.25]{BinnedData}	
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.\textwidth}
\centering
\includegraphics[scale = 0.3]{expbin}	
\end{wrapfigure}
...
\end{equation*}
Gli stimatori $\hat{\theta}_{ML}$ ottenuti con questo modo godono della propriet\`{a} di essere B.A.N.
\subsubsection{Osservazioni}
...
\begin{enumerate}
	...
	\item Come si pu\`{o} utilizzare il metodo dei minimi quadrati nel caso di misure binnate?
